<template>
  <div class="login-bg">
    <el-card class="login-card" shadow="always">
      <div class="login-title"><el-icon size="28"><Tickets /></el-icon><span>INV 发票管理系统</span></div>
      ...
      <div class="login-hint">初始管理员 admin，口令见 INV_ADMIN_PASSWORD 或首次启动日志，登录后请及时修改密码</div>
    </el-card>
  </div>
</template>

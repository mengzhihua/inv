...
import com.inv.system.audit.OpLogInterceptor;
import com.inv.system.auth.AuthInterceptor;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    /** 允许跨域的前端来源，逗号分隔（inv.cors.origins / INV_CORS_ORIGINS）；同源部署可留空 */
    @Value("${inv.cors.origins:http://localhost:5173}")
